  ...
  return (
    <div className="relative flex flex-col w-full gap-y-2.5">
      ...
      <input
        ...
        type={type}
        step="0.01"
        className={`text-xs w-full py-2 px-3 font-medium bg-white dark:bg-[#1E2139] text-[#0C0E16] dark:text-white border border-[#DFE3FA] dark:border-[#252945] rounded-md outline-none transition disabled:cursor-not-allowed focus:ring-2 focus:border-primary
            ${
              errors[id] &&
